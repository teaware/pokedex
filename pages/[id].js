...
function Post({ pokemon, pokemonSpecies }) {
  ...
  return (
    ...
    >
      <div
        className={`poke-detail p-4 h-screen w-full mx-auto ${bgc}`}
        style={{ maxHeight: 812 }}
      >
        ...
        <div className="w-full sm:w-1/2 m-auto rounded-md bg-white px-4 py-2 divide-y-2 divide-gray-500 divide-dotted">
